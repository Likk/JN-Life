package JN::Life::Engine::Main::GooglePerhaps;

=head1 NAME

JN::Life::Engine::Main::GooglePerhaps - Perhaps?.

=head1 DESCRIPTION

JN::Life::Engine::Main::GooglePerhaps is Perhaps word by google for Jossenabe.
